...
public class MainApp extends Application {
    ...
    public MainApp() {
        ...
        productData.add(new Product("Jajko",32,ProductType.Food,true));
        productData.add(new Product("Pepsi",67,ProductType.Drink,true));
        productData.add(new Product("Ibuprofen",32,ProductType.Medicament,true));
        productData.add(new Product("Kotlet",0,ProductType.Food,false));
    }
    ...
    public void showProductOverview() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(MainApp.class.getResource("../view/ProductsGUI.fxml"));
